        ...
        <div className="container-safe mx-auto max-w-7xl py-8 sm:py-12 md:py-16">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-10 sm:mb-12 md:mb-16">
                {[1, 2, 3, 4].map((i) => (
                    <div
                        key={i}
                        className="p-4 sm:p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl animate-pulse"
                    >
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gray-200 dark:bg-gray-800 rounded-lg" />
                            <div className="w-12 h-6 sm:w-14 sm:h-7 bg-gray-200 dark:bg-gray-800 rounded" />
                        </div>
                        <div className="w-16 h-3 bg-gray-200 dark:bg-gray-800 rounded mb-1" />
            ...
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
                ...
                {/* Main heading */}
                <div className="w-64 sm:w-80 h-8 sm:h-10 md:h-12 bg-gray-200 dark:bg-gray-800 rounded-lg mx-auto mb-4 animate-pulse" />

                {/* Subheading */}
                <div className="w-full max-w-md h-4 bg-gray-200 dark:bg-gray-800 rounded mx-auto animate-pulse" />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
                        ...
                        <div className="space-y-3">
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="flex items-center gap-2">
                                    ...
                                    <div className="w-40 h-3 bg-gray-200 dark:bg-gray-800 rounded" />
                                </div>
                            ))}
                        </div>
                ...
                {/* Guide Card Skeleton */}
                <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 border-2 border-blue-200 dark:border-blue-800 rounded-2xl overflow-hidden animate-pulse">
                    <div className="p-6 sm:p-8 space-y-6">
                        {/* "POPULAR" BADGE */}
