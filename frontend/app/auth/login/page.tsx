            ...
            <div className="container-safe mx-auto max-w-xl relative z-10 min-h-[90vh] flex flex-col justify-center py-12 px-4">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black text-gray-900 dark:text-white tracking-tight mb-3">
                        Sign In to <span className="text-blue-600">SafariHub</span>
                    </h1>
                ...
                <div className="mt-12 flex justify-center gap-6 text-[10px] font-black uppercase tracking-widest text-gray-400">
                    ...
                    <Link href="/contact" className="hover:text-gray-600 dark:hover:text-gray-200 transition-colors">Support</Link>
                </div>
            </div>
