      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            <div className="h-7 w-48 surface-section rounded-full" />
            <div className="h-10 w-56 surface-section rounded-lg" />
            <div className="h-5 w-72 surface-section rounded" />
          </div>
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <div className="surface-card border border-theme rounded-2xl p-6 sm:p-8 space-y-6">
            ...
            <div className="h-11 surface-section rounded-lg mt-4" />
          </div>
        </div>
      </div>
    </div>
