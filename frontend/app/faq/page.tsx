...
const FAQS = [
  // General
  {
    ...
    answer: 'SafariHub is a travel marketplace connecting travelers with verified local guides in Lebanon and Turkey. We focus on halal-friendly tourism, ensuring authentic experiences with trust and safety at the core.'
  },
  {
    id: 2,
    category: 'general',
  ...
  },
  {
    ...
    answer: 'We currently operate in Lebanon and Turkey, with tours available in major cities like Istanbul, Cappadocia, Beirut, and Byblos. We plan to expand to more countries soon.'
  },
...
const FAQItem = ({ faq, isOpen, onToggle }: FAQItemProps) => {
  return (
    <div className="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden bg-white dark:bg-gray-900 hover:shadow-md transition-shadow">
      <button
        onClick={onToggle}
          ...
          <div className="container-safe mx-auto max-w-4xl">
            ...
            <div className="relative mb-8">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-4 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              {searchTerm && (
                <button
          ...
          <div className="container-safe mx-auto max-w-3xl">
            ...
            {filteredFAQs.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl">
                <HelpCircle className="w-12 h-12 mx-auto mb-4 text-gray-300 dark:text-gray-700" />
            ...
            <div className="mt-12 p-8 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 border border-blue-200 dark:border-blue-800 rounded-2xl text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                >
