  ...
  return (
    <div className="min-h-screen surface-base flex flex-col">
      ...
      <div className="flex flex-1 relative lg:pt-16">
        {/* Sidebar - Desktop */}
        <aside className={`hidden lg:block fixed left-0 top-16 h-[calc(100vh-4rem)] surface-base transition-all duration-300 overflow-x-hidden overflow-y-auto ${isCollapsed ? 'w-20' : 'w-64'} z-40`}>
        ...
        <main className={`flex-1 min-w-0 relative lg:ml-20 ${!isCollapsed ? 'lg:ml-64' : ''}`}>
          <div className="lg:hidden h-14 glass-theme flex items-center justify-between px-4 sticky top-0 z-30 shadow-sm">
