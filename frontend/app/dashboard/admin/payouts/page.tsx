...
const StatusBadge = ({ status }: { status: PayoutStatus }) => {
 const styles = {
 pending: 'bg-accent-light/10 dark:bg-accent-dark/10 dark:bg-accent-light/10 dark:bg-accent-dark/10 text-accent-light dark:text-accent-dark dark:text-amber-400 border-accent-light dark:border-accent-dark dark:border-accent-light dark:border-accent-dark/50',
 frozen: 'bg-primary-light/10 dark:bg-primary-light/10 text-blue-700 dark:text-primary-dark border-primary-light dark:border-primary-dark dark:border-primary-light dark:border-primary-dark/50',
 ...
 completed: 'bg-success-green/10 dark:bg-success-green/10 text-emerald-700 dark:text-emerald-400 border-success-green dark:border-success-green/50',
 failed: 'bg-danger-red/10 dark:bg-danger-red/10 text-red-700 dark:text-red-400 border-danger-red dark:border-danger-red/50',
 cancelled: 'surface-section text-theme-secondary border-theme'
 }
...
const MethodBadge = ({ method }: { method: PayoutMethod }) => {
 ...
 bank: 'bg-primary-light/10 dark:bg-primary-light/10 text-blue-700 dark:text-primary-dark border-primary-light dark:border-primary-dark dark:border-primary-light dark:border-primary-dark/50',
 paypal: 'bg-accent-light/10 dark:bg-accent-dark/10 dark:bg-accent-light/10 dark:bg-accent-dark/10 text-accent-light dark:text-accent-dark dark:text-amber-400 border-accent-light dark:border-accent-dark dark:border-accent-light dark:border-accent-dark/50',
 card: 'bg-success-green/10 dark:bg-success-green/10 text-emerald-700 dark:text-emerald-400 border-success-green dark:border-success-green/50'
 }
...
const FeeTierBadge = ({ tier }: { tier: Payout['feeTier'] }) => {
 const styles = {
 bronze: 'bg-accent-light/10 dark:bg-accent-dark/10 dark:bg-accent-light/10 dark:bg-accent-dark/10 text-accent-light dark:text-accent-dark dark:text-amber-400 border-accent-light dark:border-accent-dark dark:border-accent-light dark:border-accent-dark/50',
 silver: 'surface-section text-theme-secondary border-theme',
 gold: 'bg-accent-light/10 dark:bg-accent-dark/10 dark:bg-accent-light/10 dark:bg-accent-dark/10 text-accent-light dark:text-accent-dark dark:text-amber-400 border-accent-light dark:border-accent-dark dark:border-accent-light dark:border-accent-dark/50',
 platinum: 'bg-primary-light/10 dark:bg-primary-light/10 text-blue-700 dark:text-primary-dark border-primary-light dark:border-primary-dark dark:border-primary-light dark:border-primary-dark/50'
 }
...
const CurrencyRateModal = ({ isOpen, onClose, rate, onSave }: any) => {
 ...
 <div className="text-center p-4 surface-section rounded-xl">
 <p className="text-sm text-theme-muted mb-1">Current Rate</p>
 ...
 step="0.0001"
 className="w-full px-4 py-2 surface-section border border-theme rounded-xl text-sm text-theme-primary focus:outline-none focus:ring-2 focus:ring-primary-light dark:ring-primary-dark"
 />
 </div>
 ...
 className="w-full px-4 py-2 surface-section border border-theme rounded-xl text-sm text-theme-primary focus:outline-none focus:ring-2 focus:ring-primary-light dark:ring-primary-dark resize-none"
 />
 </div>
...
const PayoutDetailsModal = ({ isOpen, onClose, payout }: any) => {
 ...
 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 ">
 <div className="w-full max-w-2xl surface-card rounded-2xl shadow-2xl max-h-[90vh] overflow-hidden border border-theme">
 {/* Header */}
 ...
 <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary-light to-primary-dark p-0.5">
 ...
 <h4 className="text-xl font-bold text-theme-primary">{payout.guideName}</h4>
 <p className="text-sm text-theme-muted ">{payout.guideEmail}</p>
 <p className="text-xs text-theme-muted mt-1">ID: {payout.guideId}</p>
 </div>
 </div>
 ...
 <h5 className="text-sm font-medium text-theme-secondary mb-2">Gross Amount</h5>
 <p className="text-2xl font-bold text-theme-primary">
 {payout.currency === 'USD' && '$'}
 {payout.currency === 'TRY' && '₺'}
 ...
 <div className="p-4 surface-section rounded-xl border border-theme">
 <h5 className="text-sm font-medium text-theme-secondary mb-2">Platform Fee</h5>
 <p className="text-2xl font-bold text-danger-red dark:text-red-400">
 ...
 <p className="text-3xl font-bold text-success-green dark:text-emerald-400">
 ...
 {/* Fee Tier Info */}
 <div className="p-4 surface-section rounded-xl border border-theme">
 <h5 className="text-sm font-medium text-theme-secondary mb-3">Fee Tier</h5>
 ...
 <div className="grid grid-cols-2 gap-4">
 <div className="p-4 surface-section rounded-xl border border-theme">
 <h5 className="text-sm font-medium text-theme-secondary mb-2">Method</h5>
 <MethodBadge method={payout.method} />
 <p className="text-xs text-theme-muted mt-2">{payout.methodDetails}</p>
 </div>
 <div className="p-4 surface-section rounded-xl border border-theme">
 <h5 className="text-sm font-medium text-theme-secondary mb-2">Tour</h5>
 <p className="text-sm text-theme-primary">{payout.tourTitle || 'N/A'}</p>
 <p className="text-xs text-theme-muted mt-1">Booking: {payout.bookingId}</p>
 </div>
 </div>

 {/* Timeline */}
 <div className="p-4 surface-section rounded-xl border border-theme">
 <h5 className="text-sm font-medium text-theme-secondary mb-3">Timeline</h5>
 ...
 {payout.processedAt && (
 <div className="flex justify-between text-sm">
 <span className="text-theme-muted ">Processed:</span>
 <span className="text-theme-primary">{new Date(payout.processedAt).toLocaleString()}</span>
 </div>
 )}
 {payout.completedAt && (
 <div className="flex justify-between text-sm">
 <span className="text-theme-muted ">Completed:</span>
 <span className="text-theme-primary">{new Date(payout.completedAt).toLocaleString()}</span>
 </div>
 )}
 {payout.estimatedRelease && (
 <div className="flex justify-between text-sm">
 <span className="text-theme-muted ">Estimated Release:</span>
 <span className="text-accent-light dark:text-accent-dark dark:text-amber-400">{new Date(payout.estimatedRelease).toLocaleString()}</span>
 </div>
 )}
 </div>
 </div>
 ...
 <h5 className="text-sm font-medium text-accent-light dark:text-accent-dark dark:text-amber-400 mb-2">Notes</h5>
 <p className="text-sm text-accent-light dark:text-accent-dark dark:text-accent-light dark:text-accent-dark">{payout.notes}</p>
 </div>
 )}
...
export default function AdminPayoutPage() {
 ...
 {feeTiers.map(tier => (
 <div key={tier.tier} className="p-4 surface-card border border-theme rounded-xl">
 <div className="flex items-center justify-between mb-2">
 <FeeTierBadge tier={tier.tier} />
 <span className="text-xs text-theme-muted ">{tier.guidesCount} guides</span>
 </div>
 ...
 className="w-20 px-2 py-1 surface-section border border-theme rounded-lg text-sm text-theme-primary"
 />
 <button
 onClick={() => handleFeeTierUpdate(tier.tier, tier.currentFee)}
 className="px-3 py-1 bg-primary-light hover:bg-primary-light-hover text-white text-xs font-medium rounded-lg transition-colors"
 >
 Update
 </button>
 </div>
 ...
 <div className="mb-6">
 <h2 className="text-lg font-semibold text-theme-primary mb-3 flex items-center gap-2">
 <Globe className="w-5 h-5 text-primary-light dark:text-primary-dark dark:text-primary-dark " />
 Currency Exchange Rates
 </h2>
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
 {currencyRates.map(rate => (
 <div key={`${rate.from}-${rate.to}`} className="p-4 surface-card border border-theme rounded-xl">
 <div className="flex items-center justify-between mb-2">
 <span className="text-sm font-medium text-theme-primary">
 {rate.from} → {rate.to}
 </span>
 {rate.isOverridden && (
 <span className="px-2 py-0.5 bg-accent-light/20 dark:bg-accent-dark/20 dark:bg-amber-900/30 text-accent-light dark:text-accent-dark dark:text-amber-300 text-xs rounded-full">
 Overridden
 </span>
 )}
 </div>
 ...
 className="w-full pl-11 pr-11 py-3 surface-card border border-theme rounded-xl text-sm text-theme-primary placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-light dark:ring-primary-dark shadow-sm"
 />
 {searchTerm && (
 ...
 <tr>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Payout ID</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Guide</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Amount</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Method</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Tier</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Status</th>
 <th className="px-6 py-4 text-left text-xs font-medium text-theme-muted uppercase tracking-wider">Date</th>
 ...
 <tr key={payout.id} className="hover:surface-section dark:hover:surface-card transition-colors">
 ...
 <span className="text-sm text-theme-secondary">{payout.guideName}</span>
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 {paginatedPayouts.map((payout) => (
 <div key={payout.id} className="p-4 surface-card border border-theme rounded-xl">
 <div className="flex items-start justify-between mb-3">
 <div>
 <div className="font-semibold text-theme-primary">{payout.payoutId}</div>
 <div className="text-xs text-theme-muted ">{payout.guideName}</div>
 </div>
 <StatusBadge status={payout.status} />
 </div>
 ...
 <DollarSign className="w-8 h-8 text-primary-light dark:text-primary-dark dark:text-primary-dark " />
 </div>
 <h3 className="text-lg font-semibold text-theme-primary mb-2">No payouts found</h3>
