...
">
 ...
 <span className={`
 text-xs font-medium
 ${trend === 'up' ? 'text-success-green dark:text-emerald-400' : 'text-danger-red dark:text-red-400'}
 `}>
 {trendValue}
 </span>
 )}
...
">
 <Ticket className="w-5 h-5 text-primary-light dark:text-primary-dark dark:text-primary-dark " />
 </div>
 <div>
 <div className="flex items-center gap-2 mb-1">
 <h3 className="font-bold text-lg text-theme-primary font-mono">
 {promo.code}
 </h3>
 <button
...
"
 title="Copy code"
 >
 {copied ? <CheckCircle className="w-3 h-3 text-success-green" /> : <Copy className="w-3 h-3" />}
 </button>
 </div>
 ...
 <div className="h-8 w-px surface-section" />
 <div>
 ...
 <div className="h-1.5 surface-section rounded-full overflow-hidden">
 <div
 className={`h-full rounded-full ${redemptionRate && redemptionRate > 80 ? 'bg-danger-red' :
 redemptionRate && redemptionRate > 50 ? 'bg-accent-light/10 dark:bg-accent-dark' :
 'bg-success-green'
 }`}
 ...
 px-5 py-2
 surface-section
 text-xs text-theme-secondary hover:surface-section dark:hover:surface-card
 transition-colors
...
"
 ...
 <div>
 <div className="text-xs text-theme-muted mb-1">Start Date</div>
 ...
 <div>
 <div className="text-xs text-theme-muted mb-1">End Date</div>
 <div className="flex items-center gap-1 text-sm text-theme-primary">
 <Calendar className="w-3 h-3" />
 {endDate}
 </div>
 ...
 <span className="text-theme-muted ">Minimum spend</span>
 <span className="font-medium text-theme-primary">${promo.minSpend}</span>
 </div>
 )}
 {promo.maxDiscount && (
 <div className="flex items-center justify-between text-sm">
 <span className="text-theme-muted ">Maximum discount</span>
 <span className="font-medium text-theme-primary">${promo.maxDiscount}</span>
 </div>
 )}
 {promo.perUserLimit && (
 <div className="flex items-center justify-between text-sm">
 <span className="text-theme-muted ">Per user limit</span>
 <span className="font-medium text-theme-primary">{promo.perUserLimit} use(s)</span>
 </div>
 )}
 <div className="flex items-center justify-between text-sm">
 <span className="text-theme-muted ">Applicable to</span>
 ...
 <div className="text-sm font-bold text-success-green dark:text-emerald-400">
 ...
 <div>
 <div className="text-xs text-theme-muted ">Avg. Order</div>
 <div className="text-sm font-bold text-theme-primary">
 ${promo.performance.averageOrderValue}
 </div>
 </div>
 <div>
 <div className="text-xs text-theme-muted ">Redemptions</div>
 <div className="text-sm font-bold text-theme-primary">
 ...
 <div className="p-2 bg-accent-light/10 dark:bg-accent-dark/10 dark:bg-amber-950/30 rounded-lg flex items-start gap-2">
 <Clock className="w-3 h-3 text-accent-light dark:text-accent-dark dark:text-amber-400 flex-shrink-0 mt-0.5" />
 ...
 {/* Actions Footer */}
 <div className="px-5 py-3 surface-section flex items-center justify-end gap-2">
 <button
...
"
 ...
 className="
 p-2
 text-danger-red hover:text-red-700
 dark:text-red-400 dark:hover:text-red-300
 hover:bg-danger-red/10 dark:hover:bg-red-950/30
 rounded-lg
 transition-colors
"
 title="Delete"
...
">
 <Calendar className="w-4 h-4 text-theme-muted shrink-0" />
...
">
 ...
 type="button"
 onClick={prevMonth}
 className="p-1.5 hover:surface-section dark:hover:surface-card rounded-lg text-theme-muted"
 >
 ...
 ${isSelected(day)
 ? 'bg-primary-light text-white font-bold ring-2 ring-primary-light dark:ring-primary-dark/20'
 : isToday(day)
 ? 'bg-primary-light/10 text-primary-light dark:text-primary-dark dark:text-primary-dark font-bold'
...
">
 ...
 <button
 onClick={onClose}
 className="p-1 hover:surface-section dark:hover:surface-card rounded-lg"
 >
 ...
 Promo Code <span className="text-danger-red">*</span>
 </label>
 <input
 type="text"
 value={formData.code}
...
"
 ...
 />
 <span className="text-sm text-theme-secondary">Guide-funded</span>
 </label>
 <label className="flex items-center gap-2">
 <input
 type="radio"
 ...
 />
 <span className="text-sm text-theme-secondary">Platform-funded</span>
 </label>
 </div>
 </div>
...
"
 ...
 className="w-4 h-4 text-primary-light dark:text-primary-dark rounded border-theme-strong focus:ring-primary-light dark:ring-primary-dark"
 />
 <span className="text-sm text-theme-secondary font-medium cursor-pointer">
 Has end date
 </span>
 </label>
 {formData.hasEndDate ? (
...
">
 ...
 <div className="
 w-10 h-10
 bg-danger-red/20 dark:bg-red-900/30
 rounded-full
 flex items-center justify-center
">
 <AlertCircle className="w-5 h-5 text-danger-red dark:text-red-400" />
 </div>
 <h3 className="text-lg font-bold text-theme-primary">
 Delete Promo Code
 </h3>
 ...
 Are you sure you want to delete <span className="font-mono font-bold text-theme-primary">{promoCode}</span>?
...
"
 ...
 <span className="text-sm text-theme-secondary font-medium">Filters:</span>
 </div>
...
">
 ...
 <ChevronDown className="w-4 h-4 text-theme-muted shrink-0 transition-transform duration-200 ui-open:rotate-180" />
 </ListboxButton>
...
">
 ...
 {selected ? (
 <span className="absolute inset-y-0 left-0 flex items-center pl-2 text-primary-light dark:text-primary-dark dark:text-primary-dark ">
...
"
 ...
 {/* Tips Section */}
 <div className="mt-8 p-4 bg-primary-light/10 rounded-lg">
 <div className="flex items-start gap-3">
 <Zap className="w-5 h-5 text-primary-light dark:text-primary-dark dark:text-primary-dark flex-shrink-0 mt-0.5" />
 <div>
