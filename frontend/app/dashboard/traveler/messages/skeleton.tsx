...
export default function TravelerMessagesSkeleton() {
  return (
    <div className="flex-1 flex flex-col h-full surface-base overflow-hidden animate-pulse">
      ...
      <div className="p-4 border-b border-theme space-y-4">
        <div className="h-10 w-full surface-section rounded-xl" />
      </div>

      <div className="flex-1 flex min-h-0 overflow-hidden">
        {/* Sidebar Skeleton */}
        <div className="w-80 border-r border-theme hidden sm:flex flex-col">
          <div className="flex-1 overflow-y-auto">
            {[1, 2, 3, 4, 5, 6].map(i => (
              <div key={i} className="p-4 border-b border-theme flex items-center gap-3">
        ...
        <div className="flex-1 flex flex-col">
          {/* Top Bar Skeleton */}
          <div className="h-16 px-6 border-b border-theme flex items-center">
