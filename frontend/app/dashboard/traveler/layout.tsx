...
export default function TravelerDashboardLayout({
 ...
 ======================================== */}
  ...
  <h1 className="font-bold text-[10px] uppercase tracking-[0.2em] text-theme-primary">Traveler Hub</h1>
  </div>
 ...
 ======================================== */}
  ...
  <div>
  <h2 className="font-bold text-xs uppercase tracking-widest text-theme-primary">Traveler</h2>
  <p className="text-[9px] font-bold text-theme-muted uppercase tracking-tighter">Command Center</p>
  </div>
  </div>
  <button
  onClick={() => setIsSidebarOpen(false)}
