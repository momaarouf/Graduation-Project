                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-12">
                            ...
                            <Section id="bookings" title="4. Bookings and Payments">
                                ...
                                <p className="mt-4 font-semibold text-gray-900 dark:text-white">Booking Types:</p>
                                <ul className="list-disc pl-6 space-y-2">
                            ...
                            <Section id="cancellations" title="5. Cancellations and Refunds">
                                <p className="font-semibold text-gray-900 dark:text-white">Cancellation Policy:</p>
                                <ul className="list-disc pl-6 space-y-2">
                                ...
                                <p className="mt-4 font-semibold text-gray-900 dark:text-white">Additional Rules:</p>
                                <ul className="list-disc pl-6 space-y-2">
                            ...
                            <Section id="contact" title="13. Contact Us">
                                ...
                                <div className="mt-4 space-y-2">
                                    <p className="flex items-center gap-2">
                                        ...
                                        <a href="mailto:legal@safaribub.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                                            legal@safaribub.com
                                        </a>
                                    </p>
                                    <p className="flex items-center gap-2">
