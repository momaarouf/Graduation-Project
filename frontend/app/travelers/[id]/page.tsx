...
function StatCard({ icon: Icon, label, value, color }: { icon: any; label: string; value: string | number; color: string }) {
 ...
 <p className="text-xs font-bold uppercase tracking-widest text-theme-muted">{label}</p>
 </div>
 </div>
 </motion.div>
 )
...
export default function TravelerProfilePage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <h1 className="text-2xl md:text-3xl font-black text-theme-primary drop-shadow-sm dark:drop-shadow-md tracking-tight leading-none transition-colors">
 {traveler.fullName}
 </h1>
 <div className="px-2.5 py-1 bg-primary-light rounded-full text-[9px] font-black uppercase tracking-widest text-white shadow-lg border border-blue-400/30">
 Top Traveler
 </div>
 </div>
 
 <p className="text-base md:text-lg font-black text-primary-light dark:text-primary-dark dark:text-blue-300 drop-shadow-sm tracking-tight italic opacity-90 transition-colors">
 ...
 <div className="flex items-center gap-2 text-[10px] font-black text-theme-primary uppercase tracking-widest surface-section dark:bg-black/40  px-4 py-2 rounded-full border border-theme dark:border-white/5 shadow-md dark:shadow-lg transition-all">
 ...
 className="px-8 py-3.5 bg-primary-light hover:bg-primary-light-hover text-white font-black text-[11px] uppercase tracking-widest rounded-2xl transition-all shadow-2xl active:scale-95 flex items-center gap-2"
 >
 ...
 <h2 className="text-2xl font-black text-theme-primary mb-6 tracking-tight">About Me</h2>
 ...
 <h3 className="text-xl font-black text-theme-primary mb-2">My Travel Stories</h3>
 ...
 <div>
 <h3 className="text-[10px] font-black text-theme-secondary mb-6 uppercase tracking-[0.25em] flex items-center gap-2">
 ...
 <span key={idx} className="px-3 py-1.5 surface-card border border-theme rounded-xl text-[10px] font-black text-theme-primary uppercase tracking-widest shadow-sm">
 {item}
 </span>
 ))}
 </div>
 ...
 <span className="text-[10px] font-bold text-theme-muted italic">No interests listed</span>
 )}
 </div>
 </div>
 </div>
