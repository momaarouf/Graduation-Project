                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-blue-800 dark:to-indigo-900 text-white">
                    <div className="container-safe mx-auto max-w-7xl py-12 sm:py-16">
                        <div className="max-w-3xl mx-auto text-center">
                            {/* Icon */}
                            <div className="inline-flex items-center justify-center w-16 h-16 mb-6 bg-white/20 backdrop-blur-sm rounded-2xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
                        ...
                        <aside className="lg:col-span-1">
                            <div className="lg:sticky lg:top-24 space-y-4">
                                ...
                                <nav className="space-y-1">
                                    {sections.map((section) => (
                                        <Link
                                            key={section.id}
                                            href={`#${section.id}`}
                                            className="block py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors border-l-2 border-transparent hover:border-blue-600 pl-3"
                                        >
                                            {section.title}
                                        </Link>
                                    ))}
                                ...
                                {/* Download PDF Button */}
                                <button className="w-full mt-6 px-4 py-3 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-2 text-sm">
                        ...
                        <div className="lg:col-span-3 space-y-12">
                            ...
                            <Section id="collection" title="Information We Collect" icon={Database}>
                                ...
                                <p className="font-semibold text-gray-900 dark:text-white mt-4">Usage Information:</p>
                                <ul className="list-disc pl-6 space-y-2">
                            ...
                            <Section id="rights" title="Your Rights" icon={UserCheck}>
                                ...
                                <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg flex items-start gap-3">
                            ...
                            <Section id="contact" title="Contact Us" icon={Mail}>
                                ...
                                <div className="mt-4 space-y-3">
                                    <p className="flex items-center gap-2">
                                        ...
                                        <a href="mailto:privacy@safaribub.com" className="text-blue-600 dark:text-blue-400 hover:underline">
                                ...
                                <p className="mt-6 font-semibold text-gray-900 dark:text-white">Mailing Address:</p>
