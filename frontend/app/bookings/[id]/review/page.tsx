...
export default function ReviewPage() {
 ...
 <div className={`p-4 rounded-2xl ${current > 0 ? 'bg-amber-500/20 text-amber-500' : 'surface-section text-theme-muted'} transition-colors ${isAggregate ? 'scale-110 shadow-lg shadow-amber-500/20' : ''}`}>
 {icon}
 </div>
 <div>
 ...
 : 'text-gray-200 group-hover/star:text-amber-300/40'
 }
 ...
 return (
 <PageLayout>
 <div className="relative min-h-screen pt-24 pb-32 overflow-hidden surface-section">
 ...
 <div className="relative aspect-square rounded-[3rem] overflow-hidden shadow-2xl border-4 border-theme">
 ...
 rows={6}
 className="relative w-full px-8 py-6 surface-card border border-theme rounded-[2.5rem] text-theme-primary placeholder-gray-500 focus:outline-none focus:border-primary-light/50 focus:ring-4 focus:ring-primary-light/10 transition-all resize-none shadow-xl"
 />
 </div>
 </motion.div>
