...
export default function GuideProfilePage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <div className="px-2.5 py-1 bg-primary-light rounded-full text-[9px] font-bold uppercase tracking-widest text-white shadow-lg border border-blue-400/30">
 Expert Partner
 </div>
 </div>
 ...
 <div className="flex items-center gap-2 text-[10px] font-bold text-theme-primary uppercase tracking-widest surface-section dark:bg-black/40  px-4 py-2 rounded-full border border-theme dark:border-white/5 shadow-md dark:shadow-lg transition-all">
 ...
 className="px-8 py-3.5 bg-primary-light hover:bg-primary-light-hover text-white font-bold text-[11px] uppercase tracking-widest rounded-2xl transition-all shadow-2xl active:scale-95 flex items-center gap-2"
 >
 ...
 <h2 className="text-2xl font-bold text-theme-primary tracking-tight uppercase">Portfolio</h2>
 <Link href={`/tours?guideId=${guide.id}`} className="text-orange-600 dark:text-orange-400 font-bold text-[10px] uppercase tracking-[0.2em] hover:opacity-75 transition-all flex items-center gap-1.5 bg-orange-50 dark:bg-orange-900/20 px-4 py-2 rounded-xl">
 See All
 ...
 <div>
 <h3 className="text-[10px] font-bold text-theme-secondary mb-6 uppercase tracking-[0.25em] flex items-center gap-2">
 ...
 <span key={idx} className="px-3 py-1.5 surface-card border border-theme rounded-xl text-[10px] font-bold text-theme-primary uppercase tracking-widest shadow-sm">
 {lang.name}
 </span>
 ))}
 </div>
 ...
 <div className="flex flex-col">
 <span className="text-[10px] font-bold uppercase tracking-widest">Premium Guide</span>
