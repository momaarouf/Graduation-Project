...
export default function GuideProfilePage({ params }: { params: Promise<{ id: string }> }) {
 ...
 <h2 className="text-2xl font-black text-theme-primary mb-6 tracking-tight">Biography</h2>
 ...
 <h2 className="text-2xl font-black text-theme-primary tracking-tight uppercase italic">Portfolio</h2>
