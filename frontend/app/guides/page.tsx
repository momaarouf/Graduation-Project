  ...
  return (
    <PageLayout>
      <div className="min-h-screen bg-white dark:bg-gray-950">
        ...
        {/* --- CINEMATIC HERO --- */}
        <section className="relative pt-32 pb-20 overflow-hidden border-b border-gray-100 dark:border-white/5">
          <div className="absolute inset-0 z-0">
            ...
            <div className="absolute top-[-20%] right-[-10%] w-[70%] h-[70%] bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-[120px]" />
          ...
          <div className="container-safe relative z-10 px-4 md:px-6">
            <div className="max-w-4xl">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-100/50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800/50 mb-6 font-sans">
                ...
                <h1 className="text-5xl md:text-8xl font-black text-gray-900 dark:text-white mb-6 leading-[0.95] tracking-tight">
                  Meet the People <br /> 
        ...
        {/* --- SEARCH & FILTERS --- */}
        <section className="sticky top-14 sm:top-16 z-40 bg-white/80 dark:bg-gray-950/80 backdrop-blur-xl border-b border-gray-100 dark:border-white/5 py-6">
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              ...
              <div className="relative w-full lg:max-w-md group">
                ...
                <input 
                  ...
                  className="w-full pl-14 pr-6 py-4 rounded-2xl bg-gray-50 dark:bg-white/5 border-0 focus:ring-2 focus:ring-blue-500 transition-all font-bold text-gray-900 dark:text-white placeholder-gray-400 shadow-sm"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                <div className="relative">
                  ...
                  <select 
                    ...
                    className="pl-11 pr-10 py-4 rounded-2xl bg-gray-50 dark:bg-white/5 border-0 focus:ring-2 focus:ring-blue-500 font-bold text-sm text-gray-700 dark:text-gray-300 appearance-none shadow-sm cursor-pointer"
                  >
                ...
                <div className="relative">
                  <Sparkles className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4 pointer-events-none" />
                  <select 
          ...
          <div className="container-safe">
            {isLoading ? (
              ...
              <div className="text-center py-40">
                <Users className="w-16 h-16 text-gray-200 dark:text-gray-800 mx-auto mb-6" />
                <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-2">No experts found</h3>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="container-safe px-4 relative z-10">
            <div className="p-12 md:p-20 rounded-[4rem] bg-gray-900 dark:bg-blue-600 text-white relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
                <div className="lg:max-w-xl text-center lg:text-left">
                  ...
                  <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                    <Link 
                      ...
                      className="px-10 py-5 bg-white text-gray-900 font-bold rounded-3xl hover:scale-105 transition-transform shadow-xl shadow-white/10 flex items-center gap-2"
                    >
                      Start Hosting <ArrowRight className="w-5 h-5" />
                    </Link>
                    <Link 
                      href="/how-it-works" 
                      className="px-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 text-white font-bold rounded-3xl hover:bg-white/20 transition-all"
                    >
                      How it works
                    </Link>
                  </div>
                ...
                <div className="relative lg:w-1/3 flex justify-center">
                    <div className="p-4 rounded-3xl bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rotate-3">
