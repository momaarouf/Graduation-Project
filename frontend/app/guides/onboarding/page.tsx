...
export const metadata: Metadata = {
  ...
  keywords: ['become a guide', 'tour guide', 'travel guide', 'earn money', 'Lebanon', 'Turkey', 'halal tourism'],
  openGraph: {
  ...
  return (
    <div className="relative group">
      ...
      {index < VERIFICATION_STEPS.length - 1 && (
        <div className="absolute left-8 top-16 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-800 group-last:hidden" />
      )}
      ...
      <div className="relative flex gap-6">
        ...
        <div className="relative">
          ...
          <div className="
            ...
            rounded-full
            flex items-center justify-center
            text-xs font-bold text-blue-600 dark:text-blue-500
          ">
            {index + 1}
          </div>
        </div>
    ...
    <PageLayout>
      ...
      <div className="pt-14 sm:pt-16">
          ...
          <div className="container-safe mx-auto max-w-7xl py-16 sm:py-20 md:py-24 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                ...
                halal-friendly experiences in Lebanon and Turkey.
              </p>
        ...
        {/* ========================================
            ...
            ======================================== */}
        <section id="how-it-works" className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-900">
          <div className="container-safe mx-auto max-w-7xl">
            {/* Section header */}
