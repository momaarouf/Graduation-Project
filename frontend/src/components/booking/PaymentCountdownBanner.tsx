...
export default function PaymentCountdownBanner({
  ...
  const containerClass = isCritical
    ? 'rounded-xl border border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-950/30 p-4'
    : isWarning
    ? 'rounded-xl border border-orange-300 dark:border-orange-700 bg-orange-50 dark:bg-orange-950/30 p-4'
    : 'rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/20 p-4'

  const iconClass = isCritical
    ? 'w-5 h-5 text-red-500 dark:text-red-400 shrink-0'
    : isWarning
    ? 'w-5 h-5 text-orange-500 dark:text-orange-400 shrink-0'
    : 'w-5 h-5 text-amber-500 dark:text-amber-400 shrink-0'
