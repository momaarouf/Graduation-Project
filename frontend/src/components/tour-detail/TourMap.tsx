...
export default function TourMap({
  ...
  if (!isValidMeetingPoint && validRoute.length === 0) {
    return (
      <div 
        className={`relative overflow-hidden rounded-2xl border-2 border-dashed border-gray-100 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-900/10 flex flex-col items-center justify-center gap-4 transition-all duration-500 animate-in fade-in zoom-in-95 ${className}`} 
        style={{ height }}
      >
        <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 group-hover:scale-110 transition-transform">
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] font-medium text-gray-500 dark:text-gray-400 max-w-[200px] mx-auto leading-relaxed">
  ...
  return (
    <div className={`relative overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 shadow-inner group ${className}`} style={{ height }}>
      ...
      <div className="absolute bottom-4 left-4 z-[1] p-3 bg-white/90 dark:bg-gray-950/90 backdrop-blur-md rounded-2xl border border-gray-200/50 dark:border-gray-800/50 shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500">
