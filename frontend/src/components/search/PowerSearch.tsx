...
function ToggleButton({ 
 ...
 const colorClasses = {
 blue: {
 active: 'bg-primary-light dark:bg-primary-dark text-white border-primary-light dark:border-primary-dark dark:border-primary-light dark:border-primary-dark',
 inactive: 'surface-card text-theme-secondary border-primary-light/20 dark:border-primary-dark/20 hover:border-primary-light dark:border-primary-dark dark:hover:border-primary-light dark:border-primary-dark',
 icon: isActive ? 'text-white' : 'text-primary-light dark:text-primary-dark dark:text-primary-dark '
 },
 emerald: {
 active: 'bg-emerald-600 dark:bg-emerald-700 text-white border-success-green dark:border-success-green',
 inactive: 'surface-card text-theme-secondary border-primary-light/20 dark:border-primary-dark/20 hover:border-success-green dark:hover:border-success-green',
 icon: isActive ? 'text-white' : 'text-success-green dark:text-emerald-400'
 },
 amber: {
 active: 'bg-amber-600 dark:bg-amber-700 text-white border-accent-light dark:border-accent-dark dark:border-accent-light dark:border-accent-dark',
 inactive: 'surface-card text-theme-secondary border-primary-light/20 dark:border-primary-dark/20 hover:border-accent-light dark:border-accent-dark dark:hover:border-accent-light dark:border-accent-dark',
 ...
 inactive: 'surface-card text-theme-secondary border-primary-light/20 dark:border-primary-dark/20 hover:border-purple-300 dark:hover:border-purple-700',
 ...
 inactive: 'surface-card text-theme-secondary border-primary-light/20 dark:border-primary-dark/20 hover:border-pink-300 dark:hover:border-pink-700',
 ...
 transition-all duration-300
 ${isActive ? 'surface-card' : `bg-${color}-50 dark:bg-${color}-950/30`}
 `}>
 <Icon className={`
 w-5 h-5
 transition-all duration-300
 ...
 <div className="w-2 h-2 rounded-full surface-card animate-pulse" />
 </div>
 )}
 </button>
 )
...
function SectionHeader({ title, icon: Icon, onClear, showClear }: SectionHeaderProps) {
 ...
 <div className="p-1.5 rounded-lg bg-primary-light/10 ">
 ...
 <button
 onClick={onClear}
 className="text-xs text-theme-muted hover:text-primary-light dark:text-primary-dark dark:hover:text-primary-dark transition-colors"
 >
 Clear
 </button>
 )}
...
export default function PowerSearch({ 
 ...
 return (
 <div className="h-full flex flex-col surface-card">
 {/* ========================================
 HEADER
 ======================================== */}
 <div className="sticky top-0 z-10 px-4 sm:px-6 py-4 surface-card border-b border-primary-light/20 dark:border-primary-dark/20">
 <div className="flex items-center justify-between">
 <div className="flex items-center gap-2">
 <SlidersHorizontal className="w-5 h-5 text-primary-light dark:text-primary-dark dark:text-primary-dark " />
 <h2 className="font-bold text-lg text-theme-primary">
 Power Search
 </h2>
 {activeFilterCount > 0 && (
 <span className="px-2 py-0.5 bg-primary-light dark:bg-primary-dark text-white text-xs font-medium rounded-full">
 {activeFilterCount}
 </span>
 )}
 </div>
 ...
 className="flex items-center gap-1 px-3 py-1.5 text-xs text-theme-secondary hover:text-primary-light dark:text-primary-dark dark:hover:text-primary-dark transition-colors"
 >
...
"
 ...
 LOCATION SECTION
 ======================================== */}
 <div className="border-b border-primary-light/20 dark:border-primary-dark/20 pb-6">
 <SectionHeader 
 title="Location" 
 icon={Globe}
 onClear={() => {
...
">
 ...
 ======================================== */}
 <div className="sticky bottom-0 px-4 sm:px-6 py-4 surface-card border-t border-primary-light/20 dark:border-primary-dark/20">
 <button
