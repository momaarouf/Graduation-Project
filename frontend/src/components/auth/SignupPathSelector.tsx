...
function PathCard({
  ...
  return (
    <div
      className={`
        group relative
        ${isSelected ? `ring-2 ring-offset-2 ring-offset-white dark:ring-offset-gray-950 ${colorToRingClass[accentColor]} ${darkColorToRingClass[darkAccentColor]}` : ''}
    ...
    >
      ...
      <div
        ...
        className={`
          ...
          ${isPopular && !isSelected ? 'border-2 border-amber-200 dark:border-amber-800' : ''}
        `}
        role="radio"
        ...
        <div className="relative p-6 sm:p-8 h-full flex flex-col">
          ...
          <div className="mb-6">
            <h3 className={`
              ...
              ${isSelected ? accentColor.replace('text-', 'text-') : ''}
              dark:${isSelected ? darkAccentColor.replace('dark:', '') : ''}
            `}>
              {title}
            </h3>
          ...
          {isSelected && (
            <div className="absolute top-4 right-4">
              <div className={`
                w-6 h-6
                rounded-full
                bg-gradient-to-r ${bgGradient} ${darkBgGradient}
