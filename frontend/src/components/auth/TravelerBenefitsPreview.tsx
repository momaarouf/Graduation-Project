...
function FeatureCard({ icon: Icon, title, description, color, index }: FeatureCardProps) {
    ...
    return (
        <div className="group relative p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden"
            style={{
        ...
        >
            ...
            {/* Title */}
            <h4 className="relative font-bold text-gray-900 dark:text-white mb-1.5 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                {title}
            </h4>

            {/* Description */}
            <p className="relative text-xs sm:text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                {description}
            </p>
        </div>
    )
...
function TierCard({
    ...
    return (
        <div className={`relative p-4 rounded-xl border-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 ${bgColor} ${borderColor} ${isCurrent ? 'ring-2 ring-offset-2 ring-blue-600 dark:ring-blue-400' : ''}`}>
            {/* Tier icon */}
            ...
            {isCurrent && (
                <div className="absolute -top-2 -right-2">
                    <div className="w-5 h-5 bg-blue-600 dark:bg-blue-700 rounded-full flex items-center justify-center border-2 border-white dark:border-gray-900">
...
export default function TravelerBenefitsPreview({
    ...
    return (
        <div className={`bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden w-full ${className}`}>
            {/* ========================================
          HEADER - Enhanced with more content
          ======================================== */}
            <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30">
                <div className="flex items-start justify-between mb-4">
                    ...
                    {/* Join count badge */}
                    <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <div className="flex flex-wrap gap-3">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full text-xs">
