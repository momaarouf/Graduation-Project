        ...
        <div className="space-y-3">
            ...
            {isOpen && (
                <motion.div
                    ...
                    className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 space-y-3"
                >
                    {/* Language Dropdown */}
                    <div>
                                            ...
                                            >
                                                {({ selected }) => (
                                                    <div className="flex items-center justify-between">
                                                        <span className={selected ? 'text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-gray-200'}>
                                                            {lang.name}
                                                        </span>
