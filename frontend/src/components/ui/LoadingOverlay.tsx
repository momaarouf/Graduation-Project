...
export default function LoadingOverlay({ isVisible, message = 'Loading...' }: LoadingOverlayProps) {
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-[9999] flex items-center justify-center surface-card overflow-hidden"
 >
 ...
 className="absolute top-[-20%] right-[-10%] w-[60%] h-[60%] bg-primary-light/10 rounded-full blur-[140px]" 
 />
 <motion.div 
 animate={{ 
 scale: [1, 1.1, 1],
 ...
 className="surface-card  border border-theme rounded-[3.5rem] p-12 sm:p-16 shadow-2xl shadow-blue-500/10 flex flex-col items-center gap-10"
 >
 ...
 className="w-32 h-32 border-[3px] border-primary-light dark:border-primary-dark/5 border-t-blue-600 rounded-full"
 />
 
 <motion.div
 animate={{ rotate: -360 }}
 transition={{ duration: 6, repeat: Infinity, ease:"linear" }}
 className="absolute inset-4 border-[1px] border-success-green/20 border-b-emerald-500 rounded-full"
 />
 ...
 >
 <Compass className="w-12 h-12 text-primary-light dark:text-primary-dark" />
 </motion.div>
 </div>
 </div>
 ...
 <p className="text-center text-theme-muted text-sm font-medium">
