    ...
    >
      ...
      <AnimatePresence>
        {!isPlaying && !isLoading && (
          ...
          >
            <div className="w-20 h-20 bg-blue-600/90 rounded-full flex items-center justify-center shadow-2xl backdrop-blur-md">
      ...
      >
        <div className="relative w-full h-1.5 bg-white/20 rounded-full mb-4 group/progress cursor-pointer overflow-hidden">
          <div 
            className="absolute top-0 left-0 h-full bg-blue-500 transition-all rounded-full z-[1]" 
