    ...
    <div className="space-y-1">
      ...
      <div className="flex gap-2" ref={dropdownRef}>
        ...
        <div className="relative">
          ...
          {/* Dropdown */}
          {isOpen && (
            <div className="absolute z-50 mt-1 w-64 max-h-60 overflow-auto bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg shadow-xl">
              <div className="p-2 sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
                <input
                  ...
                  autoFocus
                  className="w-full px-3 py-1.5 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 text-gray-900 dark:text-white"
                />
              </div>
              {filtered.map((c, i) => (
                <button
                ...
                >
                  ...
                  <span className="text-gray-900 dark:text-white flex-1">{c.name}</span>
