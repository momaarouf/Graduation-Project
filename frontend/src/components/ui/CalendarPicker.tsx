...
"July","August","September","October","November","December"
 ...
 <h4 className="text-sm font-black text-theme-primary uppercase tracking-wider">
 ...
 {weekDays.map(day => (
 <div key={day} className="text-[10px] font-black text-theme-muted uppercase text-center py-1">
 {day}
 </div>
 ))}
 </div>
