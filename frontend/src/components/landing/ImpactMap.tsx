...
function RotatingReviews() {
 ...
 <Quote className="absolute -top-2 -left-2 w-8 h-8 sm:w-10 sm:h-10 text-gray-200 opacity-50" />
 ...
 */}
 ...
 <p className="text-sm sm:text-base text-theme-secondary leading-relaxed mb-3 pl-6 line-clamp-3 sm:line-clamp-2">
 {currentReview.text}
 </p>
 </div>
 ...
 className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${index === currentIndex ? 'w-4 bg-primary-light dark:bg-blue-400' : 'surface-section hover:surface-section dark:hover:surface-section'}`}
...
function AbstractMap() {
 return (
 <div className="relative w-full aspect-[4/3] lg:aspect-auto lg:min-h-[400px] xl:min-h-[500px] bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-2xl overflow-hidden border border-theme shadow-inner">
 {/* ========================================
 ...
 <div className="absolute top-1/4 left-1/3 w-32 h-32 sm:w-48 sm:h-48 bg-blue-200/30 dark:bg-primary-light/10 rounded-full blur-3xl" />
 ...
 <div className="w-3 h-3 sm:w-4 sm:h-4 bg-primary-light dark:bg-blue-400 rounded-full animate-ping opacity-75 absolute" />
 <div className="w-3 h-3 sm:w-4 sm:h-4 bg-primary-light dark:bg-blue-400 rounded-full border-2 border-theme relative" />
 </div>
 <span className="absolute top-full left-1/2 -translate-x-1/2 mt-1 text-[10px] sm:text-xs font-medium text-theme-secondary whitespace-nowrap">
 Istanbul
 </span>
 </div>
 ...
 <div className="w-2 h-2 sm:w-3 sm:h-3 bg-emerald-600 dark:bg-emerald-400 rounded-full border-2 border-theme relative" />
 </div>
 <span className="absolute top-full left-1/2 -translate-x-1/2 mt-1 text-[10px] sm:text-xs font-medium text-theme-secondary whitespace-nowrap">
 Beirut
 </span>
 ...
 <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-theme-muted " />
 </div>
 ...
 surface-section
" />
 <span className="text-[8px] sm:text-[10px] text-theme-muted ">
 100km
 </span>
 </div>
 </div>
...
export default function ImpactMap() {
 ...
 <div className="aspect-[4/3] lg:aspect-auto lg:min-h-[400px] surface-section rounded-2xl animate-pulse" />
 ...
 {[1, 2, 3, 4].map((i) => (
 <div key={i} className="h-24 surface-section rounded-xl animate-pulse" />
 ))}
 </div>
 </div>
 </div>
 ...
 return (
 <section className="py-24 surface-base scroll-mt-16 relative overflow-hidden" aria-label="Live community impact map">
 {/* ========================================
 ...
 >
 {/* Live badge */}
 <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 bg-slate-900 text-white rounded-full text-xs sm:text-sm font-bold border border-slate-800 shadow-xl shadow-blue-500/10">
 ...
 <p className="text-lg sm:text-xl text-theme-muted max-w-2xl mx-auto leading-relaxed">
 ...
 */}
 ...
 <p className="text-xs sm:text-sm font-bold text-theme-muted capitalize tracking-normal mb-1">
 Tours This Week
 </p>
 ...
 <span className="inline-flex items-center gap-2 text-[10px] font-bold capitalize tracking-normal text-emerald-400">
 ...
 <span className="inline-flex items-center gap-2 text-[10px] font-bold capitalize tracking-normal text-primary-light dark:text-primary-dark">
 ...
 <span className="inline-flex items-center gap-2 text-[10px] font-bold capitalize tracking-normal text-purple-400">
 ...
 <p className="text-[10px] font-bold capitalize tracking-normal text-theme-muted">
 24 cities & growing
 </p>
 </motion.div>
 </div>
 ...
 */}
 ...
 whileInView={{ opacity: 1, y: 0 }}
 viewport={{ once: true }}
 className="p-8 surface-card  rounded-[2.5rem] border border-theme-strong shadow-2xl"
 >
 <div className="flex items-center gap-3 mb-6">
 <MessageCircle className="w-5 h-5 text-primary-light dark:text-primary-dark" />
 <h3 className="font-bold text-theme-primary capitalize tracking-normal text-sm">
 Explorer Pulse
 </h3>
 ...
 <Link href="/impact" className="inline-flex items-center gap-2 text-sm text-theme-secondary hover:text-primary-light dark:text-primary-dark dark:hover:text-primary-dark transition-colors duration-300 group">
 ...
 <div
 key={i}
 className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 border-2 border-theme-strong"
 />
 ))}
 </div>
 <span className="text-sm font-bold text-theme-muted capitalize tracking-normal">
