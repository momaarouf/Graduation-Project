...
const CATEGORIES = [
 ...
 darkBorderColor: 'dark:border-success-green',
 ...
 darkBorderColor: 'dark:border-primary-light dark:border-primary-dark',
 hoverBg: 'hover:bg-primary-light/10',
 darkHoverBg: 'dark:hover:surface-base',
 ...
 borderColor: 'border-accent-light dark:border-accent-dark',
 darkBorderColor: 'dark:border-accent-light dark:border-accent-dark',
...
function CategoryTile({ category }: CategoryTileProps) {
 ...
 ICON CONTAINER
 ======================================== */}
 <div className="relative flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 mb-3 sm:mb-4 rounded-lg surface-card shadow-sm transition-transform duration-300 group-hover:scale-110">
 ...
 <h3 className={`font-semibold text-base sm:text-lg text-theme-primary mb-1 group-hover:${category.lightColor} group-hover:${category.darkColor} transition-colors duration-300`}>
 {category.name}
 </h3>

 <p className="text-xs sm:text-sm text-theme-muted mb-2 line-clamp-2">
 ...
 <span className="text-xs px-2 py-1 rounded-full surface-section text-theme-secondary">
 {category.count}
 </span>
 </div>
 </div>
...
export default function CategoryTiles() {
 ...
 if (!mounted) {
 return (
 <section className="py-12 sm:py-16 surface-card">
 <div className="container-safe mx-auto">
 {/* Header Skeleton */}
 <div className="text-center mb-10">
 <div className="h-8 w-48 surface-section rounded-lg mx-auto mb-4" />
 <div className="h-4 w-96 max-w-full surface-section rounded-lg mx-auto" />
 </div>
 ...
 <div
 key={i}
 className="h-48 surface-section rounded-xl animate-pulse"
 />
 ))}
 </div>
 </div>
 ...
 return (
 <section className="py-12 sm:py-16 surface-card scroll-mt-16" aria-label="Tour categories">
 <div className="container-safe mx-auto">
 ...
 {/* Main heading */}
 <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-theme-primary mb-3">
 Curated Categories
 </h2>
